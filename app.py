...
nome_prof = st.sidebar.text_input("Nome do profissional", "Hanna Pinheiro Vieira Sales")
coren_prof = st.sidebar.text_input("COREN", "982842")
cargo_prof = st.sidebar.text_input("Cargo", "Enfermeira")
setor_prof = st.sidebar.text_input("Unidade/Setor", "Clínica Médica")
